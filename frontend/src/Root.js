  ...
  return (
    <>
      <Helmet>
        ...
        <meta content="쏘스윗 매니저" name="apple-mobile-web-app-title" />
        <link href="app_icon.png" rel="shortcut icon" />
        <link href="app_icon.png" rel="apple-touch-icon" sizes="180x180" />
      ...
      <Box bgColor={mainColor} m={'0'} overflow={'hidden'} ref={div} style={{ fontFamily: 'GmarketSans' }}>
        ...
        <Box bgColor={'white'} overflowX={'hidden'} zIndex={54}>
          ...
          <Outlet h={`calc(80vh + ${statusBarHeight})`} overflowX={'hidden'} zIndex={56} />
        </Box>
